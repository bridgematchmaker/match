...
$result_count = mysql_query("SELECT * FROM orders WHERE user_id='$user_id' AND orders.type >= '0';");
...
$page_zapros = "SELECT * FROM orders WHERE user_id='$user_id' AND orders.type >= '0' ORDER BY order_id DESC LIMIT $quantity OFFSET $list;";
                                            ...
                                            <table class="table  table-custom">
                                                ...
                                                <?
                                                    ...
                                                    for ($i = 0; $i<$num_result; $i++) 
                                                    {
                                                        ...
                                                        $order_date_add = $row['date_add'];
                                                        $order_girl_id = $row['girl_id'];
                                                        $order_type = $row['type'];
                                                        ...
                                                        {
                                                            case 0:
                                                                $order_status_print = "New";
                                                            break;
                                                        
                                                            case 1:
                                                                $order_status_print = "Pending";
                                                            break;
                                                    
                                                            case 2:
                                                                $order_status_print = "Сompleted";
                                                            break;
                                                    
                                                            case 3:
                                                                $order_status_print = "Canceled";
                                                            break;	
                                                        }
                                                    ...
                                                    switch ($order_type)
                                                        {
                                                            case 0:
                                                                $order_type_print = "E-Mail";
                                                            break;
                                                        
                                                            case 1:
                                                                $order_type_print = "Conference";
                                                            break;
                                                    
                                                            case 2:
                                                                $order_type_print = "Gift";
                                                            break;
                                                        ...
                                                        echo("
                                                            <tr>
                                                                <td>$order_id</td>
                                                                <td>$order_type_print</td>
                                                                <td>$order_girl_id</td>
                                                                <td>$order_status_print</td>
                                                                <td>$order_date_add</td>
