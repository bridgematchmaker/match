...
<div class="site-wrapper">
    <div class="container">
        <div class="row">
            ...
            <div class="main-content col-md-9" style="margin-top:-20px;">
				<div class="member-registration-page">
                            <h2 class="page-title">My profile</h2>
                            <form action="./function/my_profile_end.php" method="POST" class="member-register-form" enctype="multipart/form-data">
                                <div class="row">
                                <div class="col-md-6 left">
                                    <div class="form-group">
                                        <label for="first-name">First name<span class="required"> *</span></label>
                                        <input type="text" name="first_name" class="form-control require" id="first-name" value="<? echo $first_name; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="last-name">Last name<span class="required"> *</span></label>
                                        <input type="text" name="last_name" class="form-control require" id="last-name" value="<? echo $last_name; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question1" class="form-control require" id="nationality">
                                            <?
												if($question1 <> "")
													{
														echo('<option value="'.$question1.'">'.$question1.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question2" class="form-control" id="religion">
                                            <?
												if($question2 <> "")
													{
														echo('<option value="'.$question2.'">'.$question2.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="birthday" type="text" class="form-control require" id="date-birth" value="<? echo $birthday; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question5" class="form-control" id="body-type">
                                            <?
												if($question5 <> "")
													{
														echo('<option value="'.$question5.'">'.$question5.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question6" class="form-control require" id="eye-color">
                                            <?
												if($question6 <> "")
													{
														echo('<option value="'.$question6.'">'.$question6.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question7" class="form-control require" id="hair-color">
                                            <?
												if($question7 <> "")
													{
														echo('<option value="'.$question7.'">'.$question7.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question8" class="form-control" id="education">
                                            <?
												if($question8 <> "")
													{
														echo('<option value="'.$question8.'">'.$question8.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                ...
                                <div class="col-md-6 right">
									...
									<div class="form-group">
                                        ...
                                        <select name="question10" class="form-control" id="marital-status">
                                            <?
												if($question10 <> "")
													{
														echo('<option value="'.$question10.'">'.$question10.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
									 ...
									 <div class="form-group">
                                        ...
                                        <select name="question4" class="form-control  require" id="weight">
                                            <?
												if($question4 <> "")
													{
														echo('<option value="'.$question4.'">'.$question4.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
									...
									<div class="form-group">
                                        ...
                                        <select name="question3" class="form-control require" id="height">
                                            <?
												if($question3 <> "")
													{
														echo('<option value="'.$question3.'">'.$question3.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question9" class="form-control require" id="attitude-smoke">
                                            <?
												if($question9 <> "")
													{
														echo('<option value="'.$question9.'">'.$question9.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question11" class="form-control require" id="orientation">
                                            <?
												if($question11 <> "")
													{
														echo('<option value="'.$question11.'">'.$question11.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
										...
										<input name="question12" type="text" class="form-control" id="lonely" value="<? echo $question12; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="profession">Your profession?</label>
										<input name="question13" type="text" class="form-control" id="profession" value="<? echo $question13; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question14" class="form-control" id="annual-income">
                                            <?
												if($question14 <> "")
													{
														echo('<option value="'.$question14.'">'.$question14.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question15" class="form-control require" id="have-children">
                                            <?
												if($question15 <> "")
													{
														echo('<option value="'.$question15.'">'.$question15.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="question16" class="form-control require" id="native-language">
											<?
												if($question16 <> "")
													{
														echo('<option value="'.$question16.'">'.$question16.'</option>');
													}
												else
													{
														echo('<option value="1" selected disabled></option>');
                                ...
                                <div class="row email-pas-tel">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="email_client" type="email" class="form-control require" id="email" value="<? echo $email_client; ?>">
                                        </div>
                                        <div class="form-group password">
                                            <label for="password">Password<span class="required"> *</span></label>
                                            <input name="password" type="password" class="form-control require" id="password" value="<? echo $password; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="telefon" type="tel" class="form-control require" id="phone" value="<? echo $telefon; ?>">
                                        </div>
                                    </div>
                                </div>
