...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/feed_video.css" rel="stylesheet" type="text/css">
		<!--Style Content Page-->
        <!-- Favicon -->
                ...
                <div class="photo-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-xl-6">
                                <div class="photo-block-title">
                                    <img src="assets/images/img-icon-video.png" alt="">
                                    <h5>
                                        <span>Events</span>
                                        My new Video
                                    </h5>
                    ...
                    <div class="photo-block-body">
                        <div class="photo-block-body-inner media">
                            <div class="img-block video-block mr-3">
                                <a href="<? echo $feed_video; ?>  " data-iframe="true" data-lightgallery="item">
...
<!-- Site Scripts (start)-->
    ...
    <script src="assets/js/lightgallery-script.js"></script>
    <script src="assets/js/custom.js"></script>
    <script src="assets/js/custom-description.js"></script>
    <script src="assets/js/feed_video.js"></script>
<!-- Site Scripts (end)-->
