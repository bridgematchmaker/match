...
<html lang="en">
    ...
    <head>
		...
		<!--Style Content Page-->
        <!-- Favicon -->
        <link href="assets/css/feed_foto.css" rel="stylesheet" type="text/css">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-xl-6">
                                <div class="photo-block-title">
                                    <img src="assets/images/img-block-icon.png" alt="">
                                    <h5>
                                        <span>Events</span>
                                        My new photo
                                    </h5>
                    ...
                    <div class="photo-block-body">
                        <div class="photo-block-body-inner media">
                            <div class="img-block mr-3">
                                <img width="200" src="../<? echo $feed_foto; ?>" alt="">
                            </div>
                            <div class="media-body">
...
<!-- Site Scripts (start)-->
    ...
    <script src="assets/js/feed_foto.js"></script>
<!-- Site Scripts (end)-->
