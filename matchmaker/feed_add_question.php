...
<div style="padding:20px;">
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
            <h1>Question to my matchmaker</h1>
            <hr>
            <form action="./function/feed_add.php" method="post">
                ...
                <div class="form-group">
                    <label for="comment1">Вопрос к мачмейкеру от девушки:</label>
                    <textarea class="form-control" name="question_girl" rows="5" id="comment1" required="required"></textarea>
                </div>

                <div class="form-group">
                    <label for="comment">Ответ от мачимейкера на вопрос девушки:</label>
                    <textarea class="form-control" name="question_match" rows="5" id="comment" required="required"></textarea>
                </div>

                
                <div class="form-group">
					<label>Оценка ответа мачмейкера:</label>
					<select name="question_rating" class="form-control" required="required">
						<option value=""></option>					
