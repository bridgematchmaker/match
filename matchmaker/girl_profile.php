					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in" id="user">
							<table class="table table-striped table-bordered">
									...
									<tr><td class="active">Email:</td><td><? echo $question45; ?></td></tr>
						...
						<div class="tab-pane fade" id="anketa1">
							<table class="table table-striped table-bordered">
									...
									<tr><td>What is your native language? </td><td><? echo $question11; ?></td></tr>
									<tr><td>What languages can you speak? </td><td><? echo $question12; ?></td></tr>
									<tr><td>Have children </td><td><? echo $question13; ?></td></tr>
									<tr><td>My character traits </td><td><? echo $question14; ?></td></tr>
									<tr><td>What do I expect from the search here? </td><td><? echo $question15; ?></td></tr>
									<tr><td>Profession </td><td><? echo $question16; ?></td></tr>
									<tr><td>Occupation </td><td><? echo $question17; ?></td></tr>
									<tr><td>Which countries did you visit? </td><td><? echo $question18; ?></td></tr>
									<tr><td>What countries would you like to visit? </td><td><? echo $question19; ?></td></tr>
									...
									<tr><td>What could you forgive and what can not? </td><td><? echo $question27; ?></td></tr>
									<tr><td>Why did you decide to choose an online dating site for your search? </td><td><? echo $question28; ?></td></tr>
									<tr><td>Why do you think that you haven’t found a suitable partner yet? </td><td><? echo $question29; ?></td></tr>
							</table>	
						</div>
						
						<div class="tab-pane fade" id="anketa2">
							<table class="table table-striped table-bordered">
									<tr><td>Age Range </td><td><? echo $question30; ?></td></tr>
									<tr><td>Country </td><td><? echo $question31; ?></td></tr>
									<tr><td>Height </td><td><? echo $question32; ?></td></tr>
									<tr><td>Weight </td><td><? echo $question33; ?></td></tr>
									<tr><td>Eye color </td><td><? echo $question34; ?></td></tr>
									<tr><td>Hair color </td><td><? echo $question35; ?></td></tr>
									<tr><td>Nationality </td><td><? echo $question36; ?></td></tr>
									<tr><td>Religion </td><td><? echo $question37; ?></td></tr>
									<tr><td>Have children </td><td><? echo $question38; ?></td></tr>
									<tr><td>Desired traits of character in a man </td><td><? echo $question39; ?></td></tr>
									<tr><td>Character traits that you can not be tolerate with </td><td><? echo $question40; ?></td></tr>
									<tr><td>Do you want the man to know your native language or another language in which you can communicate? </td><td><? echo $question41; ?></td></tr>
									<tr><td>A man should prefer an active or passive rest? </td><td><? echo $question42; ?></td></tr>
									<tr><td>Describe the man you would like to meet on our website. What is most important for you? </td><td><? echo $question43; ?></td></tr>
