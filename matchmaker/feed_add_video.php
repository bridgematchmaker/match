		...
		<div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
            ...
            <form action="./function/feed_add.php" method="post">
                ...
                <div class="form-group">
					...
					<input name="video" type="text" class="form-control rounded" required="required">
				</div>

                <div class="form-group">
                    <label for="comment">Описание видео:</label>
                    <textarea class="form-control" name="video_description" rows="5" id="comment" required="required"></textarea>
                </div>
