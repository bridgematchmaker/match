...
$zapros = "SELECT * FROM girls_foto_document WHERE girl_id='$girl_id' AND foto_document_id='$foto_id';";
...
////////////////Удаляем из базы/////////////////////////////
$sql = "DELETE FROM girls_foto_document WHERE girl_id='$girl_id' AND foto_document_id='$foto_id';";
