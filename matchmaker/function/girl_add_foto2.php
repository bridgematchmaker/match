...
function make_upload($file){	
	...
	$name = time().".".$name_type;
	copy($file['tmp_name'], '../../uploads/girls/gallery_foto/' . $name);
	$foto = 'uploads/girls/gallery_foto/'.$name;
	
	////////////////////////Ресайз фото////////////////////////
	$img = AcImage::createImage('../../uploads/girls/gallery_foto/' . $name);
	...
	unlink('../../uploads/girls/gallery_foto/' . $name);
	$img->save('../../uploads/girls/gallery_foto/' . $name);
	///////////////////////////////////////////////////////////
	
	$sql = "INSERT INTO girls_foto (girl_id,foto) VALUES ('$girl_id', '$foto')";
