...
$sql = "UPDATE clients SET matchmaker_login='None', status_system='4' WHERE user_id='$user_id'";
...
$email_name = "auto_email_6"; // Название шаблона письма
...
echo	("
			<script>alert('Пользователь удален');</script><script>javascript:window.location='../client_profile.php?user_id=".$user_id."'</script>
		");
///////////////////////////////////////////////////////
?>
