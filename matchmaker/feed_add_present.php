	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
            ...
            <form action="./function/feed_add.php" method="post">
                ...
                <div class="form-group">
                    <label for="comment1">Поле для ввода описания качеств девушек:</label>
                    <textarea class="form-control" name="present_property" rows="5" id="comment1" required="required"></textarea>
                </div>
