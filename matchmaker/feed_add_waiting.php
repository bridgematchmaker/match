	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
            ...
            <form enctype='multipart/form-data' action="./function/feed_add_foto_end.php" method="post">
                ...
                <div class="form-group">
                    <label for="comment">Описание что ждет девушка:</label>
                    <textarea class="form-control" name="waiting_description" rows="5" id="comment" required="required"></textarea>
                </div>
