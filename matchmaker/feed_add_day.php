	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
            ...
            <form action="./function/feed_add.php" method="post">
                ...
                <div class="form-group">
					<label>Тип дня:</label>
					<select name="day_status" class="form-control" required="required">
						<option value=""></option>					
						<option value="Positive day">Positive day</option>
                        <option value="Negative day">Negative day</option>
					</select>
				</div>

                <div class="form-group">
					<label>Рейтинг дня:</label>
					<select name="day_rating" class="form-control" required="required">
						<option value=""></option>					
                ...
                <div class="form-group">
                    <label for="comment">Описание дня:</label>
                    <textarea class="form-control" name="day_description" rows="5" id="comment" required="required"></textarea>
                </div>
