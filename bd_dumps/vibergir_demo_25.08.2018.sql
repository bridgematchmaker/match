...
-- Время создания: Авг 25 2018 г., 13:12
...
(2, 'email@gmail.com', '698d51a19d8a121ce581499d7b701668', 'Petya', 'Petrov', '', '+380931234567', 'uploads/client/avatar.jpg', 'match1', '3', '1', '0', '1', '1', '1', '1990-05-01', '2018-06-01', '2018-06-18', ''),
...
(1, 2, 'email2@gmail.com', 1, 1, 'match1', 'Клиент ID:2 сделал заказ Skype звонка девушке ID:1', '', '', '', '2018-05-17', '2018-08-25', 3),
...
(3, 2, 'email@gmail.com', 5, 0, 'match1', 'Клиент ID:2 отправил E-Mail для девушки ID:5', 'Русский текст, Text English', 'uploads/client/email/1535181155.jpg', '', '2018-08-25', '2018-08-25', 3),
(4, 2, 'email@gmail.com', 0, 0, 'match1', 'Клиент ID:2 отправил E-Mail для девушки ID:', 'Текст письма', '', '', '2018-08-25', '2018-08-25', 3),
(5, 2, 'email@gmail.com', 0, 0, 'match1', 'Клиент ID:2 отправил E-Mail для девушки ID:', 'adsfsdfdf', '', '', '2018-08-25', '2018-08-25', 3);
...
--
ALTER TABLE `girls`
  MODIFY `girl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=230;
