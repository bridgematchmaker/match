...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 03 2018 г., 09:59
...
--
-- Структура таблицы `clients_girl_ask`
--

CREATE TABLE IF NOT EXISTS `clients_girl_ask` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `girl_id` int(11) NOT NULL,
  `status_ask1` varchar(8) NOT NULL DEFAULT '0',
  `status_ask2` varchar(8) NOT NULL DEFAULT '0',
  `status_ask3` varchar(8) NOT NULL DEFAULT '0',
  `status_ask4` varchar(8) NOT NULL DEFAULT '0',
  `status_ask5` varchar(8) NOT NULL DEFAULT '0',
  `status_ask6` varchar(8) NOT NULL DEFAULT '0',
  `status_ask7` varchar(8) NOT NULL DEFAULT '0',
  `status_ask8` varchar(8) NOT NULL DEFAULT '0',
  `status_ask9` varchar(8) NOT NULL DEFAULT '0',
  `status_ask10` varchar(8) NOT NULL DEFAULT '0',
  `status_ask11` varchar(8) NOT NULL DEFAULT '0',
  `status_ask12` varchar(8) NOT NULL DEFAULT '0',
  `status_ask13` varchar(8) NOT NULL DEFAULT '0',
  `status_ask14` varchar(8) NOT NULL DEFAULT '0',
  `status_ask15` varchar(8) NOT NULL DEFAULT '0',
  `status_ask16` varchar(8) NOT NULL DEFAULT '0',
  `status_ask17` varchar(8) NOT NULL DEFAULT '0',
  `status_ask18` varchar(8) NOT NULL DEFAULT '0',
  `status_ask19` varchar(8) NOT NULL DEFAULT '0',
  `status_ask20` varchar(8) NOT NULL DEFAULT '0',
  `status_ask21` varchar(8) NOT NULL DEFAULT '0',
  `status_ask22` varchar(8) NOT NULL DEFAULT '0',
  `status_ask23` varchar(8) NOT NULL DEFAULT '0',
  `status_ask24` varchar(8) NOT NULL DEFAULT '0',
  `status_ask25` varchar(8) NOT NULL DEFAULT '0',
  `status_ask26` varchar(8) NOT NULL DEFAULT '0',
  `status_ask27` varchar(8) NOT NULL DEFAULT '0',
  `status_ask28` varchar(8) NOT NULL DEFAULT '0',
  `status_ask29` varchar(8) NOT NULL DEFAULT '0',
  `status_ask30` varchar(8) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
