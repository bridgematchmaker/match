...
-- Время создания: Окт 22 2018 г., 13:53
...
(500, 'dmitry.plohotnyuk@gmail.com', '24375c13f81103f27a83b7d5daa4d59c', 'Dmitry', 'Plohotnyuk', 'Ukraine', '+380688989207', 'uploads/client/1535616399.jpg', 'match1', '2', '0', '0', '0', '0', '1', '1990-07-31', '2018-08-30', '2018-10-17', ''),
...
(33, 500, 4, 'Inna', '9', '2018-09-28', '0'),
(34, 500, 5, 'Natalia', '8', '2018-09-28', '0'),
...
(12, 'Viktoriya', '9359452@gmail.com', 'v.lialko', 'viktoria2544', '6a4e647e75175c1a5cb4dc6543fb68e9', '', '', 'Ukraine', 'Kharkiv', '+380679359452', '8-30  21-30', '0', '5', '', 'uploads/match/1538563223.jpg', '0'),
...
CREATE TABLE `orders` (
  ...
  `user_skype` varchar(128) NOT NULL,
  `girl_id` int(11) NOT NULL,
...
INSERT INTO `orders` (`order_id`, `user_id`, `user_email`, `user_skype`, `girl_id`, `type`, `match_login_processed`, `description1`, `description2`, `skype_time`, `mail_client`, `foto_client`, `mail_girl`, `date_add`, `date_end`, `status`) VALUES
...
--
ALTER TABLE `girls`
  MODIFY `girl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2309;

--
-- AUTO_INCREMENT для таблицы `girls_foto`
--
ALTER TABLE `girls_foto`
  MODIFY `foto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
