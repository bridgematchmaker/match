                                ...
                                <div class="row email-pas-tel">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-inline"><input style="width: 100px; margin-right: 5px;" name="telefon" type="tel" class="form-control require" id="phone" value="" readonly> <input name="telefon2" type="tel" class="form-control require" id="phone2" value=""></div>
                                        </div>
                                    </div>
                                </div>
